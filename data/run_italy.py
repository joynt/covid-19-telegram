...
from data.utils.italy_data import compute_provinces_confirmed_cases
...
def italy(path):
    ...
    plot_cases(confirmed, align_indexes, ALIGN_AROUND, path)
    plot_growth(growths, align_indexes, ALIGN_AROUND, path)
